...
func TestHeldHostPrune(t *testing.T) {
	...
	for _, tt := range testTable {
		...
		offerPool.EXPECT().ResetExpiredHeldHostSummaries(gomock.Any()).Return(tt.mockResetExpiredHostSummaries)
		hostPruner := NewHeldHostPruner(offerPool, testScope)
