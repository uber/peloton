...
- [upgrade.proto](#upgrade.proto)
    - [AbortRequest](#peloton.api.upgrade.AbortRequest)
    - [AbortResponse](#peloton.api.upgrade.AbortResponse)
    - [CreateRequest](#peloton.api.upgrade.CreateRequest)
    - [CreateResponse](#peloton.api.upgrade.CreateResponse)
    - [GetRequest](#peloton.api.upgrade.GetRequest)
    - [GetResponse](#peloton.api.upgrade.GetResponse)
    - [InvalidWorkflowState](#peloton.api.upgrade.InvalidWorkflowState)
    - [ListRequest](#peloton.api.upgrade.ListRequest)
    - [ListResponse](#peloton.api.upgrade.ListResponse)
    - [ListResponse.Result](#peloton.api.upgrade.ListResponse.Result)
    - [PauseRequest](#peloton.api.upgrade.PauseRequest)
    - [PauseResponse](#peloton.api.upgrade.PauseResponse)
    - [ResumeRequest](#peloton.api.upgrade.ResumeRequest)
    - [ResumeResponse](#peloton.api.upgrade.ResumeResponse)
    - [RollbackRequest](#peloton.api.upgrade.RollbackRequest)
    - [RollbackResponse](#peloton.api.upgrade.RollbackResponse)
    - [UpgradeInfo](#peloton.api.upgrade.UpgradeInfo)
    - [UpgradeOptions](#peloton.api.upgrade.UpgradeOptions)
    - [UpgradeSpec](#peloton.api.upgrade.UpgradeSpec)
    - [WorkflowAlreadyExists](#peloton.api.upgrade.WorkflowAlreadyExists)
    - [WorkflowID](#peloton.api.upgrade.WorkflowID)
    - [WorkflowNotFound](#peloton.api.upgrade.WorkflowNotFound)
  
    - [State](#peloton.api.upgrade.State)
  
  
    - [UpgradeManager](#peloton.api.upgrade.UpgradeManager)
...
<a name="peloton.api.upgrade.AbortRequest"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workflowId | [WorkflowID](#peloton.api.upgrade.WorkflowID) |  |  |
| softAbort | [bool](#bool) |  |  |
...
<a name="peloton.api.upgrade.AbortResponse"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| notFound | [WorkflowNotFound](#peloton.api.upgrade.WorkflowNotFound) |  |  |
| invalidState | [InvalidWorkflowState](#peloton.api.upgrade.InvalidWorkflowState) |  |  |
...
<a name="peloton.api.upgrade.CreateRequest"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| spec | [UpgradeSpec](#peloton.api.upgrade.UpgradeSpec) |  |  |
...
<a name="peloton.api.upgrade.CreateResponse"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| result | [WorkflowID](#peloton.api.upgrade.WorkflowID) |  |  |
| notFound | [.peloton.api.errors.JobNotFound](#peloton.api.upgrade..peloton.api.errors.JobNotFound) |  |  |
| alreadyExists | [WorkflowAlreadyExists](#peloton.api.upgrade.WorkflowAlreadyExists) |  |  |
...
<a name="peloton.api.upgrade.GetRequest"/>
...
<a name="peloton.api.upgrade.GetResponse"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| result | [UpgradeInfo](#peloton.api.upgrade.UpgradeInfo) |  |  |
| notFound | [WorkflowNotFound](#peloton.api.upgrade.WorkflowNotFound) |  |  |
...
<a name="peloton.api.upgrade.InvalidWorkflowState"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workflowId | [WorkflowID](#peloton.api.upgrade.WorkflowID) |  | Entity ID of the workflow |
| invalidState | [State](#peloton.api.upgrade.State) |  | Invalid state of the workflow |
...
<a name="peloton.api.upgrade.ListRequest"/>
...
<a name="peloton.api.upgrade.ListResponse"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| result | [ListResponse.Result](#peloton.api.upgrade.ListResponse.Result) |  |  |
...
<a name="peloton.api.upgrade.ListResponse.Result"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| value | [UpgradeInfo](#peloton.api.upgrade.UpgradeInfo) | repeated |  |
...
<a name="peloton.api.upgrade.PauseRequest"/>
...
<a name="peloton.api.upgrade.PauseResponse"/>
...
<a name="peloton.api.upgrade.ResumeRequest"/>
...
<a name="peloton.api.upgrade.ResumeResponse"/>
...
<a name="peloton.api.upgrade.RollbackRequest"/>
...
<a name="peloton.api.upgrade.RollbackResponse"/>
...
<a name="peloton.api.upgrade.UpgradeInfo"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| workflowId | [WorkflowID](#peloton.api.upgrade.WorkflowID) |  | Workflow ID of the job upgrade |
| numTasksDone | [int32](#int32) |  | Number of tasks that have been upgraded |
| numTasksRemaining | [int32](#int32) |  | Number of tasks to be upgraded |
| state | [State](#peloton.api.upgrade.State) |  | Runtime state of the upgrade workflow |
...
<a name="peloton.api.upgrade.UpgradeOptions"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| batchSize | [int32](#int32) |  | Upgrade batch size of the deployment |
| batchPercentage | [double](#double) |  | Upgrade batch percentage of the deployment. If present, will take precedence over batchSize |
| stopBeforeUpgrade | [bool](#bool) |  | Whether or not to stop all instance before upgrade |
| startPaused | [bool](#bool) |  | startPaused indicates if the workflow should start in the paused state, requiring an explicit resume to initiate. |
...
<a name="peloton.api.upgrade.UpgradeSpec"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| jobId | [.peloton.api.peloton.JobID](#peloton.api.upgrade..peloton.api.peloton.JobID) |  | Entity id of the job to be upgraded |
| jobConfig | [.peloton.api.job.JobConfig](#peloton.api.upgrade..peloton.api.job.JobConfig) |  | New configuration of the job to be upgraded. The new job config will be applied to all instances in a rolling upgrade fashion without violating the job SLA |
| options | [UpgradeOptions](#peloton.api.upgrade.UpgradeOptions) |  | The options of the rolling upgrade |
...
<a name="peloton.api.upgrade.WorkflowAlreadyExists"/>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [WorkflowID](#peloton.api.upgrade.WorkflowID) |  |  |
| message | [string](#string) |  |  |
...
<a name="peloton.api.upgrade.WorkflowID"/>
...
<a name="peloton.api.upgrade.WorkflowNotFound"/>
...
<a name="peloton.api.upgrade.State"/>
...
| Name | Number | Description |
| ---- | ------ | ----------- |
| ROLLING_FORWARD | 0 | The upgrade workflow is rolling forward |
| ROLLING_BACK | 1 | The upgrade workflow is rolling back |
| PAUSED | 2 | The upgrade workflow is paused |
| SUCCEEDED | 3 | The upgrade workflow completed successfully |
| ROLLED_BACK | 4 | The upgrade workflow is rolled back |
| ABORTED | 5 | The upgrade workflow is aborted |
...
<a name="peloton.api.upgrade.UpgradeManager"/>
...
| Method Name | Request Type | Response Type | Description |
| ----------- | ------------ | ------------- | ------------|
| Create | [CreateRequest](#peloton.api.upgrade.CreateRequest) | [CreateResponse](#peloton.api.upgrade.CreateRequest) | Create a new rolling upgrade workflow for a job |
| Get | [GetRequest](#peloton.api.upgrade.GetRequest) | [GetResponse](#peloton.api.upgrade.GetRequest) | Get the upgrade workflow of a job |
| List | [ListRequest](#peloton.api.upgrade.ListRequest) | [ListResponse](#peloton.api.upgrade.ListRequest) | List all upgrade workflows that are currently running |
| Pause | [PauseRequest](#peloton.api.upgrade.PauseRequest) | [PauseResponse](#peloton.api.upgrade.PauseRequest) | Pause a running upgrade workflow |
| Resume | [ResumeRequest](#peloton.api.upgrade.ResumeRequest) | [ResumeResponse](#peloton.api.upgrade.ResumeRequest) | Resume a paused upgrade workflow |
| Rollback | [RollbackRequest](#peloton.api.upgrade.RollbackRequest) | [RollbackResponse](#peloton.api.upgrade.RollbackRequest) | Rollback an upgrade workflow |
| Abort | [AbortRequest](#peloton.api.upgrade.AbortRequest) | [AbortResponse](#peloton.api.upgrade.AbortRequest) | Abort an upgrade workflow |
