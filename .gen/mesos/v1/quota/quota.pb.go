...
func (*QuotaInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_f13a4408f22dee7c, []int{0}
}
...
func (*QuotaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f13a4408f22dee7c, []int{1}
}
...
func (*QuotaStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_f13a4408f22dee7c, []int{2}
}
...
func init() { proto.RegisterFile("mesos/v1/quota/quota.proto", fileDescriptor_f13a4408f22dee7c) }

var fileDescriptor_f13a4408f22dee7c = []byte{
