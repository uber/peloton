...
func (Event_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 0}
}
...
func (Call_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{1, 0}
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0}
}
...
type Event_Subscribed struct {
	...
	FrameworkInfo *v1.FrameworkInfo `protobuf:"bytes,2,req,name=framework_info,json=frameworkInfo" json:"framework_info,omitempty"`
	AgentInfo     *v1.AgentInfo     `protobuf:"bytes,3,req,name=agent_info,json=agentInfo" json:"agent_info,omitempty"`
	// Uniquely identifies the container of an executor run.
	ContainerId          *v1.ContainerID `protobuf:"bytes,4,opt,name=container_id,json=containerId" json:"container_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*Event_Launch) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 1}
}
...
type Event_LaunchGroup struct {
	TaskGroup            *v1.TaskGroupInfo `protobuf:"bytes,1,req,name=task_group,json=taskGroup" json:"task_group,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*Event_LaunchGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 2}
}
...
type Event_Kill struct {
	...
	KillPolicy           *v1.KillPolicy `protobuf:"bytes,2,opt,name=kill_policy,json=killPolicy" json:"kill_policy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (*Event_Kill) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 3}
}
...
func (*Event_Acknowledged) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 4}
}
...
func (*Event_Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 5}
}
...
func (*Event_Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{0, 6}
}
...
func (*Call) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{1}
}
...
type Call_Subscribe struct {
	UnacknowledgedTasks   []*v1.TaskInfo `protobuf:"bytes,1,rep,name=unacknowledged_tasks,json=unacknowledgedTasks" json:"unacknowledged_tasks,omitempty"`
...
func (*Call_Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{1, 1}
}
...
func (*Call_Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_648e6d43ca5fbba3, []int{1, 2}
}
...
func init() { proto.RegisterFile("mesos/v1/executor/executor.proto", fileDescriptor_648e6d43ca5fbba3) }

var fileDescriptor_648e6d43ca5fbba3 = []byte{
	// 857 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x94, 0x95, 0xdb, 0x6e, 0xdb, 0x46,
