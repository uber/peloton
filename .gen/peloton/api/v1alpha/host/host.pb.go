...
// source: peloton/api/v1alpha/host/host.proto

package peloton_api_v1alpha_host
...
func (HostState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_14279942b73ff102, []int{0}
}
...
type HostInfo struct {
	...
	State                HostState `protobuf:"varint,3,opt,name=state,proto3,enum=peloton.api.v1alpha.host.HostState" json:"state,omitempty"`
...
func init() {
	proto.RegisterEnum("peloton.api.v1alpha.host.HostState", HostState_name, HostState_value)
	proto.RegisterType((*HostInfo)(nil), "peloton.api.v1alpha.host.HostInfo")
}

func init() {
	proto.RegisterFile("peloton/api/v1alpha/host/host.proto", fileDescriptor_14279942b73ff102)
}

var fileDescriptor_14279942b73ff102 = []byte{
