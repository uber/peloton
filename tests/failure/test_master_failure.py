...
class TestMesosMainFailure(object):

    def test__stop_start_tasks_when_mesos_main_down_kills_tasks_when_started(self, failure_tester):
        '''
        Start Mesos main after creating a long running job and stopping the job
