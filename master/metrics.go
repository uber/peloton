...
// Metrics is the struct containing all the counters that track internal state of the Master process
type Metrics struct {
	...
	QueueAPIDequeue  tally.Counter
	QueueDequeue     tally.Counter
...
func NewMetrics(scope tally.Scope) Metrics {
	...
	m := Metrics{
		...
		QueueAPIDequeue:  queueAPIScope.Counter("dequeue"),
		QueueDequeue:     queueSuccessScope.Counter("dequeue"),
		QueueDequeueFail: queueFailScope.Counter("dequeue"),
	}
	return m
}
