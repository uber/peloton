...
mockgens: build-mockgen gens $(GOMOCK)
	...
	$(call local_mockgen,hostmgr/host,Drainer;MaintenanceHostInfoMap)
	...
	$(call local_mockgen,storage,JobStore;TaskStore;UpdateStore;FrameworkInfoStore;ResourcePoolStore;PersistentVolumeStore)
	$(call local_mockgen,storage/cassandra/api,DataStore)
	$(call local_mockgen,storage/objects,JobIndexOps;JobNameToIDOps;JobConfigOps;SecretInfoOps)
	$(call local_mockgen,storage/orm,Client;Connector)
