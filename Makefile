...
mockgens: build-mockgen pbgens $(GOMOCK)
	...
	$(call local_mockgen,jobmgr/cached,JobFactory;UpdateFactory;Job;Task;JobConfigCache;Update)
	...
	$(call local_mockgen,leader,Candidate)
	...
	$(call local_mockgen,resmgr/task,Scheduler)
